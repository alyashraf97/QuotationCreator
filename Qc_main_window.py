...
class Quote:
    ...
    def calculate_vendor_price_data(self, vendorEntryData):
        ...
        initialItemWeights=vendorInitialUnitPrices/sum(vendorInitialUnitPrices)
        vendorBoq=vendorEntryData["vendorItemQuantities"]
        vendorComission=vendorEntryData['vendorComission']
        vendorPacking=vendorEntryData['vendorPacking']
        vendorShipping=vendorEntryData['vendorShipping']
